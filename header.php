    ...
    <div style="padding-left: 5%; padding-right: 5% " >
        ...
        if(isset($_SESSION['email']) && (($_SESSION['status']=="wait") || ($_SESSION['status']=="wait-fix" || ($_SESSION['status']=="fixed") ))) {
            ...
            <div class="navbar-header">
                ...
                <a href="wait-status.php?email=<?php echo $_SESSION['email'];?>&id=<?php echo $_SESSION['id'];?>"><img src="img/logo.png" align="left" width="50px" height="auto" border="0"
                                               style="margin-right:20px"/></a>
                <a href="wait-status.php?email=<?php echo $_SESSION['email'];?>&id=<?php echo $_SESSION['id'];?>" class="navbar-brand" style="color: #FFFFFF">BG-Technician</a>
            </div>
            <?php
            ...
            <div class="navbar-header">
                ...
                <a href="admin-index.php"><img src="img/logo.png" align="left" width="50px" height="auto" border="0"
                                         style="margin-right:20px"/></a>
                <a href="admin-index.php" class="navbar-brand" style="color: #FFFFFF">BG-Technician</a>
            </div>
        <?php }else{?>
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
