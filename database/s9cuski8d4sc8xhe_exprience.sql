...
DROP TABLE IF EXISTS `exprience`;
...
LOCK TABLES `exprience` WRITE;
/*!40000 ALTER TABLE `exprience` DISABLE KEYS */;
/*!40000 ALTER TABLE `exprience` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-04-29 23:36:09
